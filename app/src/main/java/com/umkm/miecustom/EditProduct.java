...
public class EditProduct extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        title_product2 = getIntent().getStringExtra("title_product");
        image2 = String.valueOf("http://miesuhh.000webhostapp.com/admin/Res_img/dishes/"+getIntent().getStringExtra("image"));
        description2 = getIntent().getStringExtra("description");
        note2 = getIntent().getStringExtra("note");
